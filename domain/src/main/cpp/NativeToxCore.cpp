...
Java_ltd_evilcorp_domain_tox_NativeTox_toxNew(JNIEnv *env, jobject thiz, jbyteArray savedata) {
...
Java_ltd_evilcorp_domain_tox_NativeTox_toxKill(JNIEnv *env, jobject thiz, jlong toxPtr) {
...
JNIEXPORT void JNICALL
Java_ltd_evilcorp_domain_tox_NativeTox_toxBootstrap(JNIEnv *env, jobject thiz, jlong toxPtr, jstring address, jint port, jbyteArray publicKey) {
...
JNIEXPORT void JNICALL
Java_ltd_evilcorp_domain_tox_NativeTox_toxAddTcpRelay(JNIEnv *env, jobject thiz, jlong toxPtr, jstring address, jint port, jbyteArray publicKey) {
    const char *addr = env->GetStringUTFChars(address, nullptr);
    std::vector<uint8_t> pk = jba2vec(env, publicKey);
...
JNIEXPORT void JNICALL
Java_ltd_evilcorp_domain_tox_NativeTox_toxIterate(JNIEnv *env, jobject thiz, jlong toxPtr, jobject listener) {
    Tox *tox = reinterpret_cast<Tox*>(toxPtr);
...
Java_ltd_evilcorp_domain_tox_NativeTox_toxIterationInterval(JNIEnv *env, jobject thiz, jlong toxPtr) {
    return tox_iteration_interval(reinterpret_cast<Tox*>(toxPtr));
}

JNIEXPORT jbyteArray JNICALL
Java_ltd_evilcorp_domain_tox_NativeTox_toxGetName(JNIEnv *env, jobject thiz, jlong toxPtr) {
    Tox *tox = reinterpret_cast<Tox*>(toxPtr);
...
JNIEXPORT void JNICALL
Java_ltd_evilcorp_domain_tox_NativeTox_toxSetName(JNIEnv *env, jobject thiz, jlong toxPtr, jbyteArray name) {
    std::vector<uint8_t> n = jba2vec(env, name);
    tox_self_set_name(reinterpret_cast<Tox*>(toxPtr), n.data(), n.size(), nullptr);
}

JNIEXPORT jbyteArray JNICALL
Java_ltd_evilcorp_domain_tox_NativeTox_toxGetStatusMessage(JNIEnv *env, jobject thiz, jlong toxPtr) {
    Tox *tox = reinterpret_cast<Tox*>(toxPtr);
...
JNIEXPORT void JNICALL
Java_ltd_evilcorp_domain_tox_NativeTox_toxSetStatusMessage(JNIEnv *env, jobject thiz, jlong toxPtr, jbyteArray msg) {
    std::vector<uint8_t> m = jba2vec(env, msg);
    tox_self_set_status_message(reinterpret_cast<Tox*>(toxPtr), m.data(), m.size(), nullptr);
}

JNIEXPORT jbyteArray JNICALL
Java_ltd_evilcorp_domain_tox_NativeTox_toxGetAddress(JNIEnv *env, jobject thiz, jlong toxPtr) {
...
JNIEXPORT jbyteArray JNICALL
Java_ltd_evilcorp_domain_tox_NativeTox_toxGetPublicKey(JNIEnv *env, jobject thiz, jlong toxPtr) {
...
JNIEXPORT jint JNICALL
Java_ltd_evilcorp_domain_tox_NativeTox_toxGetNospam(JNIEnv *env, jobject thiz, jlong toxPtr) {
    return tox_self_get_nospam(reinterpret_cast<Tox*>(toxPtr));
}

JNIEXPORT void JNICALL
Java_ltd_evilcorp_domain_tox_NativeTox_toxSetNospam(JNIEnv *env, jobject thiz, jlong toxPtr, jint nospam) {
    tox_self_set_nospam(reinterpret_cast<Tox*>(toxPtr), nospam);
}

JNIEXPORT jbyteArray JNICALL
Java_ltd_evilcorp_domain_tox_NativeTox_toxGetSavedata(JNIEnv *env, jobject thiz, jlong toxPtr) {
    Tox *tox = reinterpret_cast<Tox*>(toxPtr);
...
// ... I will skip the rest of the implementations for brevity and implement them incrementally if needed ...
JNIEXPORT jint JNICALL Java_ltd_evilcorp_domain_tox_NativeTox_toxAddFriend(JNIEnv *env, jobject thiz, jlong toxPtr, jbyteArray pubKey, jbyteArray message) {
...
JNIEXPORT jint JNICALL Java_ltd_evilcorp_domain_tox_NativeTox_toxAddFriendNorequest(JNIEnv *env, jobject thiz, jlong toxPtr, jbyteArray pubKey) {
    std::vector<uint8_t> pk = jba2vec(env, pubKey);
    return tox_friend_add_norequest(reinterpret_cast<Tox*>(toxPtr), pk.data(), nullptr);
}

JNIEXPORT void JNICALL Java_ltd_evilcorp_domain_tox_NativeTox_toxDeleteFriend(JNIEnv *env, jobject thiz, jlong toxPtr, jint friendNumber) {
    tox_friend_delete(reinterpret_cast<Tox*>(toxPtr), friendNumber, nullptr);
}

JNIEXPORT jintArray JNICALL Java_ltd_evilcorp_domain_tox_NativeTox_toxGetFriendList(JNIEnv *env, jobject thiz, jlong toxPtr) {
    Tox *tox = reinterpret_cast<Tox*>(toxPtr);
...
JNIEXPORT jbyteArray JNICALL Java_ltd_evilcorp_domain_tox_NativeTox_toxGetFriendPublicKey(JNIEnv *env, jobject thiz, jlong toxPtr, jint friendNumber) {
    uint8_t pk[TOX_PUBLIC_KEY_SIZE];
...
JNIEXPORT jint JNICALL Java_ltd_evilcorp_domain_tox_NativeTox_toxFriendByPublicKey(JNIEnv *env, jobject thiz, jlong toxPtr, jbyteArray pubKey) {
    std::vector<uint8_t> pk = jba2vec(env, pubKey);
    return tox_friend_by_public_key(reinterpret_cast<Tox*>(toxPtr), pk.data(), nullptr);
}

JNIEXPORT jint JNICALL Java_ltd_evilcorp_domain_tox_NativeTox_toxFriendSendMessage(JNIEnv *env, jobject thiz, jlong toxPtr, jint friendNumber, jint type, jbyteArray message) {
    std::vector<uint8_t> msg = jba2vec(env, message);
    return tox_friend_send_message(reinterpret_cast<Tox*>(toxPtr), friendNumber, (TOX_MESSAGE_TYPE)type, msg.data(), msg.size(), nullptr);
}

JNIEXPORT void JNICALL Java_ltd_evilcorp_domain_tox_NativeTox_toxSetTyping(JNIEnv *env, jobject thiz, jlong toxPtr, jint friendNumber, jboolean typing) {
    tox_self_set_typing(reinterpret_cast<Tox*>(toxPtr), friendNumber, typing, nullptr);
}

JNIEXPORT jint JNICALL Java_ltd_evilcorp_domain_tox_NativeTox_toxGetSelfUserStatus(JNIEnv *env, jobject thiz, jlong toxPtr) {
    return tox_self_get_status(reinterpret_cast<Tox*>(toxPtr));
}

JNIEXPORT void JNICALL Java_ltd_evilcorp_domain_tox_NativeTox_toxSetSelfUserStatus(JNIEnv *env, jobject thiz, jlong toxPtr, jint status) {
    tox_self_set_status(reinterpret_cast<Tox*>(toxPtr), (TOX_USER_STATUS)status);
}

JNIEXPORT void JNICALL Java_ltd_evilcorp_domain_tox_NativeTox_toxFileControl(JNIEnv *env, jobject thiz, jlong toxPtr, jint friendNumber, jint fileNumber, jint control) {
    tox_file_control(reinterpret_cast<Tox*>(toxPtr), friendNumber, fileNumber, (TOX_FILE_CONTROL)control, nullptr);
}

JNIEXPORT jint JNICALL Java_ltd_evilcorp_domain_tox_NativeTox_toxFileSend(JNIEnv *env, jobject thiz, jlong toxPtr, jint friendNumber, jint kind, jlong fileSize, jbyteArray fileId, jbyteArray filename) {
...
JNIEXPORT void JNICALL Java_ltd_evilcorp_domain_tox_NativeTox_toxFileSendChunk(JNIEnv *env, jobject thiz, jlong toxPtr, jint friendNumber, jint fileNumber, jlong position, jbyteArray data) {
...
JNIEXPORT void JNICALL Java_ltd_evilcorp_domain_tox_NativeTox_toxFriendSendLosslessPacket(JNIEnv *env, jobject thiz, jlong toxPtr, jint friendNumber, jbyteArray data) {
    std::vector<uint8_t> d = jba2vec(env, data);
    tox_friend_send_lossless_packet(reinterpret_cast<Tox*>(toxPtr), friendNumber, d.data(), d.size(), nullptr);
}

// Crypto
JNIEXPORT jbyteArray JNICALL Java_ltd_evilcorp_domain_tox_NativeTox_getSalt(JNIEnv *env, jobject thiz, jbyteArray data) {
    std::vector<uint8_t> d = jba2vec(env, data);
...
JNIEXPORT jbyteArray JNICALL Java_ltd_evilcorp_domain_tox_NativeTox_passKeyDeriveWithSalt(JNIEnv *env, jobject thiz, jbyteArray passphrase, jbyteArray salt) {
...
JNIEXPORT jbyteArray JNICALL Java_ltd_evilcorp_domain_tox_NativeTox_passDecrypt(JNIEnv *env, jobject thiz, jbyteArray data, jbyteArray passkey) {
    std::vector<uint8_t> d = jba2vec(env, data);
...
JNIEXPORT jbyteArray JNICALL Java_ltd_evilcorp_domain_tox_NativeTox_passEncrypt(JNIEnv *env, jobject thiz, jbyteArray data, jbyteArray passkey) {
    std::vector<uint8_t> d = jba2vec(env, data);
    std::vector<uint8_t> p = jba2vec(env, passkey);
    uint32_t extra_len = tox_pass_encryption_extra_length();
    std::vector<uint8_t> out(d.size() + extra_len);
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    jclass cls = env->FindClass("ltd/evilcorp/domain/tox/ToxEventListener");
