    ...
    fun onGroupPeerStatus(groupNo: Int, peerId: Int, status: ltd.evilcorp.domain.tox.enums.ToxUserStatus) {
        scope.launch {
            ...
            val userStatus = when (status) {
                ltd.evilcorp.domain.tox.enums.ToxUserStatus.NONE -> ltd.evilcorp.domain.model.UserStatus.None
                ltd.evilcorp.domain.tox.enums.ToxUserStatus.AWAY -> ltd.evilcorp.domain.model.UserStatus.Away
                ltd.evilcorp.domain.tox.enums.ToxUserStatus.BUSY -> ltd.evilcorp.domain.model.UserStatus.Busy
            }
